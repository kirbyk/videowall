...
class PanelsControllerTest < ActionController::TestCase
  ...
  test "should create panel" do
    assert_difference('Panel.count') do
      post :create, panel: { active: @panel.active, content: @panel.content, height: @panel.height, name: @panel.name, width: @panel.width }
    end
  ...
  test "should update panel" do
    patch :update, id: @panel, panel: { active: @panel.active, content: @panel.content, height: @panel.height, name: @panel.name, width: @panel.width }
    assert_redirected_to panel_path(assigns(:panel))
  end
